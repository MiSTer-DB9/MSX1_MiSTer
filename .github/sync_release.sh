...
UPSTREAM_REPO="https://github.com/MiSTer-devel/MSX1_MiSTer.git"
CORE_NAME=(MSX2)
...
UPSTREAM_CORE_NAME=(MSX1)
MAIN_BRANCH="MSX2"
UPSTREAM_BRANCH="MSX2"
COMPILATION_INPUT=(MSX1.qpf)
COMPILATION_OUTPUT=(output_files/MSX1.rbf)
